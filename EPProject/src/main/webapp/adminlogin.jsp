                    ...
                    <form method="post" action="checkadminlogin.jsp">
                        <div class="input-boxes">
                            ...
                            <div class="input-box">
                                ...
                                <input type="password" name="pwd" placeholder="Enter your password" required="required" />
                            </div>
                            <div class="text"><a href="#">Forgot password?</a></div>
                            <div class="button input-box">
                                <input type="submit" value="Login" />
                            </div>
                            <div class="text sign-up-text">want to register as Job-seeker? <a href="seekerregistra.jsp">Signup now</a></div>
                        </div>
                    </form>
                </div>
            </div>
